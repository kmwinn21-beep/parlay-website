...
export const metadata: Metadata = {
  title: "Request a Demo — Parlay",
  description:
    "See Parlay in action. Book a 30-minute live walkthrough of the conference scoring engines, rep performance tracking, and ROI analytics.",
};
